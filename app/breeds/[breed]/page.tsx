      ...
      <div className="mx-2 sm:mx-4 md:mx-8 lg:mx-12">
        ...
        <div className="flex flex-col xl:flex-row xl:items-start xl:justify-start justify-center items-center w-full max-w-full gap-4">
          ...
          <div className="w-1/3 flex flex-col md:w-full md:text-lg text-md text-gray-700 gap-4 xl:gap-6">
            <div className="">
              <strong> Here are a list of our desirable oodle breeds</strong> 
            </div>
            <div className="flex flex-col">
              <Link href="./cavoodle">Cavoodle</Link>
              <Link href="./groodle">Groodle</Link>
              <Link href="./labradoodle">Labradoodle</Link>
              <Link href="./poodle">Poodle</Link>
              <Link href="./spoodle">Spoodle</Link>
            </div>
          </div>
          <div className={`${fredoka.className} text-red-500`}>If you are interested in other breeds not listed here, email or call us below</div>
