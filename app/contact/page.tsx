        ...
        <div className="flex flex-col sm:flex-row gap-8 w-full max-w-4xl items-center">
          ...
          <div className="flex flex-col text-lg gap-6 justify-center items-center w-full sm:w-1/2">
            <div className="bg-sky-900 p-6 rounded-md w-full shadow-md text-white text-center">
              ...
              <a href="tel:+61431892647" className="flex justify-center">
              ...
              <a href="mailto:puppies@pickapooch.com.au" className="flex justify-center pt-3">
                <Button className="bg-red-500 hover:bg-red-400 w-full">puppies@pickapooch.com.au</Button>
              </a>
            </div>
            <div className="bg-sky-900 text-lg rounded-md p-6 text-white w-full shadow-md">
              <h2 className="text-2xl text-center pb-3">Operating Hours</h2>
