          ...
          <main className="flex flex-col text-left text-black gap-10 items-center justify-center mt-8">
            ...
            <div className="flex flex-col sm:flex-row gap-8 w-full max-w-4xl items-center mt-4">
              ...
              <div className="flex flex-col text-lg gap-6 justify-center items-center w-full sm:w-1/2">
                <div className="bg-gradient-to-br from-sky-900 to-blue-800 p-6 rounded-md w-full shadow-md text-white text-center">
                  <p className="pb-3">
                ...
                <div className="bg-gradient-to-br from-sky-900 to-blue-800 text-lg rounded-md p-6 text-white w-full shadow-md">
